...
use crate::bls12_381_ark::arkworks;
use crate::bls12_381_ark::utils::{pad_g1_point, remove_g1_padding};
...
pub const PRECOMPILE: PrecompileWithAddress =
    PrecompileWithAddress(G1_ADD_ADDRESS, Precompile::Standard(g1_add));
...
pub fn g1_add(input: &Bytes, gas_limit: u64) -> PrecompileResult {
    ...
    let unpadded_result = arkworks::p1_add_affine_bytes(a, b)?;
